    ...
    for rowNumber in inputMatrix:
        ...
        for element in rowNumber:
            ...
            if (row == 0) and (index == 0):
                ...
                buildItem = max((buildRow[-1] + gapScore), (gapScoreList[index - 1] + gapScore),
                                (gapScoreList[index - 1] + inputMatrix[row][index]))
                # print("Case 2 Triggered:",buildItem)

            elif (index == 0) and (row != 0):

                buildItem = max((gapScoreList[row] + gapScore), (outputMatrix[row - 1][index] + gapScore),
                                (gapScoreList[row - 1] + inputMatrix[row][index]))
                # print("Case 3 Triggered:",buildItem)
            else:

                buildItem = max((buildRow[-1] + gapScore), (outputMatrix[row - 1][index] + gapScore),
                                (outputMatrix[row - 1][index - 1] + inputMatrix[row][index]))
...
def traceback_non_family(printableMatrix, outputMatrix, gapScore, pairwiseDistanceTable):

    binaryDictNonFamily = {'1': [0, 1, 1, 0], '2': [0, 1, 1, 0], '3': [0, 1, 0, 1], '4': [0, 1, 0, 1], '5': [1, 1, 0, 0], '6': [1, 1, 0, 0], '7': [1, 1, 1, 1], '8': [1, 1, 1, 1], '9': [1, 1, 1, 1], '10': [1, 1, 1, 1], '11': [1, 1, 0, 0], '12': [1, 1, 0, 0], '13': [1, 0, 0, 0], '14': [1, 0, 0, 0], '15': [1, 0, 1, 1], '16': [1, 0, 1, 1], '17': [0, 0, 1, 0], '18': [0, 0, 1, 0], '19': [0, 0, 0, 1], '20': [0, 0, 0, 1], '21': [0, 1, 0, 1], '22': [0, 1, 0, 1], '23': [0, 1, 1, 0], '24': [0, 1, 1, 0], '25': [1, 0, 1, 1], '26': [1, 0, 1, 1], '27': [1, 0, 0, 0], '28': [1, 0, 0, 0], '29': [0, 0, 0, 1], '30': [0, 0, 0, 1], '31': [0, 0, 1, 0], '32': [0, 0, 1, 0], '1r': [1, 1, 0, 0], '2r': [1, 1, 0, 0], '3r': [1, 1, 1, 1], '4r': [1, 1, 1, 1], '5r': [0, 1, 0, 1], '6r': [0, 1, 0, 1], '7r': [0, 1, 1, 0], '8r': [0, 1, 1, 0], '9r': [1, 0, 0, 0], '10r': [1, 0, 0, 0], '11r': [1, 0, 1, 1], '12r': [1, 0, 1, 1], '13r': [1, 1, 0, 0], '14r': [1, 1, 0, 0], '15r': [1, 1, 1, 1], '16r': [1, 1, 1, 1], '17r': [0, 1, 0, 1], '18r': [0, 1, 0, 1], '19r': [0, 1, 1, 0], '20r': [0, 1, 1, 0], '21r': [0, 0, 0, 1], '22r': [0, 0, 0, 1], '23r': [0, 0, 1, 0], '24r': [0, 0, 1, 0], '25r': [0, 0, 0, 1], '26r': [0, 0, 0, 1], '27r': [0, 0, 1, 0], '28r': [0, 0, 1, 0], '29r': [1, 0, 0, 0], '30r': [1, 0, 0, 0], '31r': [1, 0, 1, 1], '32r': [1, 0, 1, 1]}
    ...
    while index < len(sList):
        ...
        if sList[index] == "-" or tList[index] == "-":
            alignmentTopLabel.append(" ")

        elif binaryDictNonFamily[sList[index]] == binaryDictNonFamily[tList[index]]:
            alignmentTopLabel.append("*")
